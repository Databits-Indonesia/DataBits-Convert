...
async function nUpTool() {
  ...
  const pageSizeKey = (document.getElementById('n-up-output-page-size') as HTMLSelectElement)
  ...
  const borderColor = hexToRgb(
    (document.getElementById('n-up-border-color') as HTMLInputElement).value
  );
