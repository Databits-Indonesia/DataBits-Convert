...
async function fixPageSize() {
    ...
    const targetSizeKey = (document.getElementById('fix-page-size-target-size') as HTMLSelectElement).value;
    const orientation = (document.getElementById('fix-page-size-orientation') as HTMLSelectElement).value;
    const scalingMode = (document.querySelector('input[name="fix-page-size-scaling-mode"]:checked') as HTMLInputElement).value;
    const backgroundColor = hexToRgb((document.getElementById('fix-page-size-background-color') as HTMLInputElement).value);
    ...
    try {
        ...
        if (targetSizeKey === 'Custom') {
            const width = parseFloat((document.getElementById('fix-page-size-custom-width') as HTMLInputElement).value);
            const height = parseFloat((document.getElementById('fix-page-size-custom-height') as HTMLInputElement).value);
            const units = (document.getElementById('fix-page-size-custom-units') as HTMLSelectElement).value;
