...
export async function pdfToMarkdown() {
  ...
  try {
    ...
    const includePageNumbers = (document.getElementById('pdf-to-markdown-page-numbers') as HTMLInputElement)?.checked || false;
    const includeTitle = (document.getElementById('pdf-to-markdown-title') as HTMLInputElement)?.checked || false;
    const headingStyle = (document.getElementById('pdf-to-markdown-headings') as HTMLSelectElement)?.value || 'auto';
